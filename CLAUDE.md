# data-sync-opensearch Development Guidelines
...
# Add commands for Shell scripts (bash) for automation, JSON for index mappings and queries, Docker Compose YAML for orchestration

## Code Style

Shell scripts (bash) for automation, JSON for index mappings and queries, Docker Compose YAML for orchestration: Follow standard conventions
